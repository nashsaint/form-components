...
## Notes
- Components are source-first; Vite will compile the `.vue` files when installed. If a bundler prebundles with esbuild, add the package to `optimizeDeps.exclude`.
- Add stories/tests locally if you want stronger contracts before publishing.
