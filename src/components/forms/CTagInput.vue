<template>
    <div class="space-y-1">
        ...
        <div
            class="flex min-h-[3.5rem] flex-wrap gap-2 border px-3 py-2 focus-within:border-indigo-500 focus-within:ring focus-within:ring-indigo-200"
            :class="[
                rectangular ? 'rounded-none' : 'rounded-2xl',
        ...
        >
            <span
                ...
                :key="`${tag}-${index}`"
                class="inline-flex items-center gap-1 bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700"
